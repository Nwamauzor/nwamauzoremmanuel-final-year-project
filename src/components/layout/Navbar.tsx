...
const navItems: NavItem[] = [
  ...
  { label: "History", href: "/history" },
  {
    ...
    href: "/departments",
    subItems: [
      { label: "Computer Science & AI", href: "/departments/cs-ai" },
      { label: "Data Science", href: "/departments/data-science" },
      { label: "ICT", href: "/departments/ict" },
      { label: "Software Technology", href: "/departments/software" },
    ],
  },
  {
    label: "Dean's Office",
    href: "/deans-office",
    subItems: [
      { label: "Dean's Profile", href: "/deans-office/dean" },
      { label: "Faculty Officer", href: "/deans-office/faculty-officer" },
      { label: "Faculty Staff", href: "/deans-office/staff" },
      { label: "Journals", href: "/deans-office/journals" },
    ],
  },
  {
    label: "Students",
    ...
    subItems: [
      ...
      { label: "Conduct & Discipline", href: "/students/conduct" },
    ],
  },
      ...
      <nav className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <motion.img
              src={uiLogo}
              alt="University of Nigeria - Faculty of Computing"

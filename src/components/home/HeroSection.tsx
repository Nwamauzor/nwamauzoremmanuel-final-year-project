...
const HeroSection = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center bg-gradient-hero overflow-hidden circuit-bg">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        <motion.div
          className="absolute -bottom-40 -left-40 w-96 h-96 rounded-full bg-primary-light/10 blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.3, 0.5, 0.3],
          }}
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Faculty of{" "}
              <span className="text-gradient-sky">Computing</span>
            </motion.h1>
            ...
            >
              <a
                href="/departments"
                className="inline-flex items-center justify-center px-8 py-4 bg-primary text-primary-foreground font-semibold rounded-xl shadow-md hover:shadow-lg hover:bg-primary-dark transition-all"
              >
                Explore Departments
              </a>
              <a
                href="/students/admission"
                className="inline-flex items-center justify-center px-8 py-4 bg-card text-foreground font-semibold rounded-xl border border-border shadow-sm hover:border-primary hover:text-primary transition-all"
              >
                Apply Now
              </a>
            </motion.div>
